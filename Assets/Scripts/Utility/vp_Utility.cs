...
// compile only for unity 5+ editor
    ...
    public static UnityEngine.Object Instantiate( UnityEngine.Object original, Vector3 position, Quaternion rotation )
    {
		...
		if (PoolManager.Instance == null || !PoolManager.Instance.enabled || !(original is GameObject))
		{
			return GameObject.Instantiate(original, position, rotation);
		}
		else
		{
			return PoolManager.Spawn((original as GameObject), position, rotation);
		}
				//vp_GlobalEventReturn<UnityEngine.Object, Vector3, Quaternion, UnityEngine.Object>.Send("PoolManager Instantiate", original, position, rotation);
    ...
    public static void Destroy(UnityEngine.Object obj)
    {
		...
		if (PoolManager.Instance == null || !PoolManager.Instance.enabled || !(obj is GameObject))
			UnityEngine.Object.Destroy(obj);
		else
			PoolManager.Despawn(obj as GameObject);
    ...
    public static void Destroy(UnityEngine.Object obj, float t)
    {
		...
		else
		{
			vp_Timer.In(Mathf.Max(0, t), () =>
				{
                    PoolManager.Despawn(obj as GameObject, t);
				});
		}

			//vp_GlobalEvent<UnityEngine.Object, float>.Send("PoolManager Destroy", obj, t);
